    ...
    <SafeAreaView style={styles.container} edges={['top']}>
      ...
      <View style={styles.header}>
        ...
        <TouchableOpacity 
          ...
          activeOpacity={0.7}
        >
            <Ionicons name="globe-outline" size={16} color="#555" style={{marginRight: 5}} />
            <Text style={styles.languageText}>{t.langName}</Text>
            <Ionicons name="swap-horizontal" size={16} color="#555" style={{marginLeft: 5}}/>
        </TouchableOpacity>
      </View>
        ...
        <View style={styles.card}>
          ...
          <View style={styles.inputGroup}>
            <View style={styles.labelContainer}>
                ...
                <Ionicons name="information-circle" size={16} color="black" style={{marginLeft: 4}} />
            </View>
